...
const Hero = forwardRef<HTMLDivElement>((_, ref) => {
  ...
  return (
    <div ref={ref} className='h-screen w-full pt-20 pb-8 relative'>
        {/* Left Blob */}
      <div className='blob w-60 h-60 md:w-90 md:h-90 bg-pink-300 rounded-full absolute z-0 top-1/3 left-4 md:left-1/6 filter blur-3xl opacity-60 animate-blob'></div>


      <div className='blob w-80 h-80 md:w-130 md:h-130 bg-blue-600 rounded-full absolute z-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 filter blur-3xl opacity-50 animate-blob3'></div>

      {/* Right Blob */}
      <div className='blob w-60 h-60 md:w-90 md:h-90 bg-violet-400 rounded-full absolute z-0 top-2/3 right-4 md:right-auto md:left-3/5 filter blur-3xl opacity-60 animate-blob2'></div>
